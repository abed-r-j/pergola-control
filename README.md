...
A cross-platform mobile application for controlling an intelligent pergola system with automated sun tracking, manual control, and real-time monitoring.
...
- **Real-Time Dashboard**: Live metrics with sparkline graphs
